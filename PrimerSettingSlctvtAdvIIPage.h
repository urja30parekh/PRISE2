#ifndef PrimerSettingSlctvtAdvIIPage_H
#define PrimerSettingSlctvtAdvIIPage_H

#include <QWizardPage>
#include "Data.h"

namespace Ui {
    class PrimerSettingSlctvtAdvIIPage;
}

class PrimerSettingSlctvtAdvIIPage : public QWizardPage {
    Q_OBJECT
public:
    PrimerSettingSlctvtAdvIIPage(QWidget *parent = 0);
    ~PrimerSettingSlctvtAdvIIPage();

protected:
    void changeEvent(QEvent *e);

private:
    Ui::PrimerSettingSlctvtAdvIIPage *ui;
    int prevWidth;
    int prevHeight;
...
#endif // PrimerSettingSlctvtAdvIIPage_H
